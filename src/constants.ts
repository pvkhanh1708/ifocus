...
export const DEFAULT_COLORS: Scene[] = [
    { id: "solid-dark", type: "color", url: "#1a1a1a", name: "Chế độ tối" },
    { id: "solid-warm", type: "color", url: "#2c241b", name: "Nâu ấm" },
    // Focus colors - deep, stable tones that minimize distraction
    { id: "solid-navy", type: "color", url: "#0d1b2a", name: "Xanh navy đậm" },
    {
        id: "solid-midnight",
        type: "color",
        url: "#1b2838",
    ...
    { id: "solid-charcoal", type: "color", url: "#2d2d2d", name: "Màu than chì" },
    // Relaxation colors - calming, nature-inspired tones
    { id: "solid-forest", type: "color", url: "#1a2f1a", name: "Xanh rừng cây" },
    { id: "solid-teal", type: "color", url: "#1a3a3a", name: "Xanh mòng két đậm" },
    { id: "solid-ocean", type: "color", url: "#0a2540", name: "Xanh biển sâu" },
    { id: "solid-sage", type: "color", url: "#2f3b2f", name: "Xanh xô thơm nhẹ" },
    // Meditation colors - soft, spiritual tones
    { id: "solid-purple", type: "color", url: "#2a1f3d", name: "Tím trầm" },
    {
        id: "solid-twilight",
        type: "color",
        url: "#2d1f47",
    ...
    { id: "solid-zen", type: "color", url: "#3a3a3a", name: "Xám thiền định" },
];
...
export const DEFAULT_MUSIC: YtMusic[] = [
    ...
    },
    {
        id: "rec-011",
        videoId: "4yiEbIeCOA4",
        title: "Đường chân trời buổi sớm",
